...
ARG PACK_LIST="git make bash ca-certificates openssh-client curl wget tar tzdata jq build-base gcc musl-dev pkgconf openssl-dev libffi-dev zlib-dev linux-headers protobuf protobuf-dev"
...
ENV HOSTNAME="casjaysdevdocker-go"
...
LABEL org.opencontainers.image.source="https://github.com/casjaysdevdocker/go"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/go"
...
VOLUME [ "/config","/data","/usr/local/share/go" ]
